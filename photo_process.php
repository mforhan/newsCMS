...
/* GLOBALS */
$inbox = "inbox"; // Inbox directory is where files are uploaded

$process_array = array(  // This array defines the prefix for files and where they go
  'r_' => '/home/httpd/vhosts/cashmerevalleyrecord/httpdocs/photos/processed',
  'e_' => '/home/httpd/vhosts/leavenworthecho.com/httpdocs/photos/processed',
  'gt_' => '/home/httpd/vhosts/gazette-tribune.com/httpdocs/photos/processed',
  'lcm_' => '/home/httpd/vhosts/lakechelanmirror.com/httpdocs/photos/processed'
); // End array  

  # [0] - width, [1] - height, [2] - type, [3] - attr (width/height html)
  # Types: 1 - GIF, 2 - JPG, 3 - PNG, 4 - SWF, 5 - PSD, 6 - BMP... 
$valid_files = array( // This list the types of files that are valid in $inbox
  1 , 2 , 3
);



// 1) Open Inbox directory 
// 2) Read list of files, sort into site appropriate images (r_, e_, gt_ ...)
// 3) Verify all files are JPG/GIF or PNG (unlink all files not)
// 4) Create full/thumbnail file for each image
// 5) Create directory on appropriate site and save full/thumb 
// 6) Unlink processed files from inbox directory
// 7) * Insert record into database of added photos?
