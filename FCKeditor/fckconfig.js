...
FCKConfig.ToolbarSets["Reporter"] = [
	['Cut','Copy','Paste','PasteText','PasteWord','-','SpellCheck','-','Undo','Redo','-','Find','Replace'],
	'/',
	['Bold','Italic','Underline','-','Link','Unlink'],['FontFormat']
] ;
...
FCKConfig.FontFormats	= 'p;div;pre;h3;h4;h5' ;
